...
const Lote = ({ loteId }) => {
  ...
  useEffect(() => {
    const fetchProductos = async () => {
      try {
        const response = await fetch('httpa://backend-anta.up.railway.app/productos');
  ...
  useEffect(() => {
    const fetchLote = async () => {
      try {
        const response = await fetch(`httpa://backend-anta.up.railway.app/api/lotes_cueros/${loteId}`); // Ruta corregida
  ...
  useEffect(() => {
    const fetchSulfuradas = async () => {
      try {
        const response = await fetch(`httpa://backend-anta.up.railway.app/api/sulfuradas/${loteId}`);
        if (!response.ok) {
